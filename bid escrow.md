...
| Parameter name                              | Initial Value     | Stored value     

| Type | Description | 
| PostJobDOSFee                               | 10                | 10000             
| float      | A DOS fee that the JobPoster needs to attach to the Post Job query. The value is the minimum amount of Fiat currency to be attached as CSPR using FiatConversionRate |
| InternalAuctionTime TODO                    | 7 days            | 604800            | seconds    | The time of the Internal Auction Auction |
